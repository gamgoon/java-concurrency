...
public class Main {
    public static void main(String[] args) {
        ...
        Producer producer1 = new Producer(publisher, "System 1");
        Producer producer2 = new Producer(publisher, "System 2");

        ForkJoinTask<?> task1 = ForkJoinPool.commonPool().submit(producer1);
        ForkJoinTask<?> task2 = ForkJoinPool.commonPool().submit(producer2);
