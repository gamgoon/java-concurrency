...
public class KeywordExtractionTask implements Runnable {
    ...
    public void run() {
        ...
        System.out.println(name + ": Phaser 1");
        ...
        // Phase2
        System.out.println(name + ": Phaser 2");
    ...
    private synchronized void addKeyword(ConcurrentHashMap<String, Integer> globalKeywords, String word) {
